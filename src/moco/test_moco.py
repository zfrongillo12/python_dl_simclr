...
def run_linear_evaluation(backbone, linear_head, train_loader, test_loader, epochs=20, device='cuda', log_file=None):
    ...
    print_and_log("Starting linear evaluation...", log_file=log_file)
...
# Test MoCo backbone
# ================================================================================
def test_moco_backbone(model, train_loader, test_loader, device='cuda', num_classes=2, log_file=None):
    ...
    test_stats = run_linear_evaluation(backbone, classifier_head, train_loader=train_loader, test_loader=test_loader, device=device, log_file=log_file)
