...
# For ResNet50 and ViT [Case 1 and 3], train function
...
def main(args):
    ...
    elif args.model_type == 'VIT_Hybrid':
        # ---------------------------------------
        # Case 2: ViT Hybrid Backbone
        # ---------------------------------------
